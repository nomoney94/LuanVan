...
Public Class crpTK_DNTT_Nam
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuanVan.crpTK_DNTT_Nam.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTK_DNTT_Nam
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTK_DNTT_Nam = New crpTK_DNTT_Nam()
        rpt.Site = Me.Site
        Return rpt
    End Function

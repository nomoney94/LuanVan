...
Public Class crpTK_DNTT_Thang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuanVan.crpTK_DNTT_Thang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTK_DNTT_Thang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTK_DNTT_Thang = New crpTK_DNTT_Thang()
        rpt.Site = Me.Site
        Return rpt
    End Function

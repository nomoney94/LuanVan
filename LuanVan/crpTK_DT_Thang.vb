...
Public Class crpTK_DT_Thang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuanVan.crpTK_DT_Thang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTK_DT_Thang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTK_DT_Thang = New crpTK_DT_Thang()
        rpt.Site = Me.Site
        Return rpt
    End Function
